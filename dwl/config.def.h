...
static const Rule rules[] = {
	...
	/* examples: */
	{ "floorp",           NULL,       2,            0,           -1 }, /* Start on currently visible tags floating, not tiled */
	{ "Firefox",          NULL,       2,            0,           -1 },
};
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Up,              setmfact,         {.f = +0.05} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Right,           setmfact,         {.f = +0.05} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Down,            setmfact,         {.f = -0.05} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Left,            setmfact,         {.f = -0.05} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_C,          killclient,       {0} },
	{ MODKEY,                    XKB_KEY_Tab,        setlayout,        {.v = &layouts[0]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Tab,        setlayout,        {.v = &layouts[2]} },
